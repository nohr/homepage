    ...
    <AnimatePresence>
      {loaded && (
        <motion.nav
          ...
          className="grid pointer-events-none !text-white fixed z-40 p-4 top-0 left-0 gap-4 w-full grid-span-full h-[90px] md:pb-0 mix-blend-exclusion dark:mix-blend-difference grid-cols-6 md:grid-cols-12 items-start *:w-fit"
        >
          <Suspense>
            {/* Home */}
            <ScrollLink
              href="/"
              scrollTo={0}
              className="pointer-events-auto pt-2 order-1 col-span-2 md:col-span-4 cursor-pointer flex flex-col gap-2"
            >
              <svg
                id="Layer_2"
            ...
            {/* Tags */}
            <div className="pointer-events-none flex flex-col order-2 justify-between h-full md:h-min md:col-start-5 col-span-2 *:w-fit *:cursor-pointer">
              <ScrollLink
                href="work"
                scrollTo="#work"
            ...
            {/* Links */}
            <ScrollLink
              className="pointer-events-auto order-3 col-start-5 md:col-start-9"
              href="/about"
              scrollTo="#about"
            >
              About
            ...
            <a
              className="pointer-events-auto order-3 col-start-6 justify-self-end md:col-start-12"
              target="_blank"
